...
# Afficher le logo avec une taille réduite
col1, col2 = st.columns([5, 1])  # Colonne pour le contenu et colonne pour le logo
with col2:
    st.image(logo, width=100)  # Ajustez la largeur en pixels selon votre besoin
